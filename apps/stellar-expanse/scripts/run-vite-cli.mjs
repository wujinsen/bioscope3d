...
// pnpm may forward stray argv (e.g. "#" from pasted "pnpm dev # url") to lifecycle scripts;
// spawning vite here avoids treating those tokens as Vite's positional [root] argument.
